namespace _10_The_Heigan_Dance
{
    ...
    public class TheHeiganDance
    {
        ...
        static void PrintStats(double[] points, int[] playerPosition, string spell)
        {
        ...
        static bool IsInsideMatrix(int[] position)
        {
            int size = 15;
        ...
        static bool IsHitBySpell(int[] spellCoordinates, int[] playerPosition)
        {
