namespace BashSoft
{
    public static class ExceptionMessages
    {
        ...
        public const string DataNotInitializedExceptionMessage = "he data structure must be initialised first in order to make any operations with it.";
        ...
        public const string UnableToGoHigherInPartitionHierarchy = "The folder you are trying to access, does not exist in the partition hierarchy.";
